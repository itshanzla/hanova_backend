...
export class ListingResponseDto {
  ...
  @ApiPropertyOptional({
    description: 'Safety details provided by host',
    type: [String],
  ...
  @ApiPropertyOptional({
    description: 'Host residential apt / floor / building',
    example: 'Apt 3B',
  })
  hostAptFloor?: string;
  ...
  @ApiPropertyOptional({
    description: 'Host residential province / state / territory',
    example: 'Lagos',
  })
  hostState?: string;

  @ApiPropertyOptional({
    description: 'Host residential postal code',
    example: '100001',
  })
  hostPostalCode?: string;

  @ApiPropertyOptional({
    description: 'Is host hosting as a business?',
    example: false,
  })
